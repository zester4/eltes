...
import { approvalKey, type PendingApproval } from "../route-utils";
...
export async function POST(
  ...
  const approval: PendingApproval =
    typeof raw === "string" ? JSON.parse(raw) : (raw as PendingApproval);
        ...
        messages: [
          {
            ...
            parts: [
              {
                type: "text",
                text: `✅ Executed: ${approval.summary}\n\nResult: ${result}`,
              },
            ],
            attachments: [],
            createdAt: new Date(),
      ...
      messages: [
        {
          ...
          parts: [
            {
              type: "text",
              text: `Action rejected by user: ${approval.summary}`,
            },
          ],
          attachments: [],
          createdAt: new Date(),
