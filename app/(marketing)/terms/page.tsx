      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="font-body font-light text-white/50 text-base md:text-lg leading-relaxed space-y-6 md:space-y-12">
          <div className="space-y-4">
            ...
            <p>
              Welcome to Etles. These Terms of Service ("Terms") govern your
              access to and use of the Etles platform, website, and agent
              orchestration services (the "Services"). By using our Services,
              you agree to be bound by these Terms.
            </p>
          </div>

          <section className="space-y-6">
            <h2 className="text-3xl font-heading italic text-white">
              1. Eligibility
            </h2>
            <p>
              You must be at least 18 years old or the legal age of majority in
              your jurisdiction to use our Services. By agreeing to these Terms,
              you represent and warrant that you are eligible.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p>
              ...
              represent and warrant that all information you provide is accurate
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-heading text-white/80">
                A. Responsibility for Instructions
              </h3>
              <p>
                Etles provides autonomous agent technology. You are solely
                responsible for the instructions, commands, and prompts you
                provide to your AI agent. We are not responsible for the
                outcomes of agent actions taken based on your input.
              </p>
              ...
              <p>
                Our Services allow integration with third-party software
                ("Toolkits") via Composio. By connecting a toolkit, you
                authorize Etles to interact with that software on your behalf.
                You are responsible for ensuring your use of such toolkits
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>
                    Generating or distributing harmful, illegal, or offensive
                    content.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    of our agent orchestration layer.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="space-y-6">
            ...
            <p>
              The Services, including all software, design, and proprietary
              technology, are owned by Etles or its licensors and are protected
              by intellectual property laws. We grant you a limited,
              non-exclusive, non-transferable license to use the Services for
              your personal or internal business purposes under these Terms.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p>
              Certain portions of our Services are offered on a subscription
              basis. You agree to pay all fees associated with your selected
              plan. We reserve the right to change our pricing upon notice to
              you.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ETLES SHALL NOT BE LIABLE
          ...
          <section className="space-y-6">
            ...
            <p>
              ...
              which Etles is registered, without regard to its conflict of law
              provisions.
            </p>
          </section>
