...
export default function FeaturesPage() {
  return (
    <div className="w-full relative overflow-visible bg-black">
      {/* HERO SECTION */}
      <section className="relative w-full min-h-[600px] py-32 px-6 flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 flex flex-col items-start text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-heading italic text-white mb-6">Autonomous Workflow Execution</h2>
            ...
            <div className="flex-1 w-full">
               <div className="liquid-glass rounded-[40px] aspect-video w-full p-2 bg-white/5 overflow-hidden group">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="flex-1 flex flex-col items-start text-left">
              <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center mb-8">
                <MemoryStick className="text-white w-6 h-6" />
              </div>
              <h2 className="text-4xl md:text-5xl font-heading italic text-white mb-6">Long-term Semantic Memory</h2>
              <p className="font-body font-light text-white/60 text-lg leading-relaxed mb-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 flex flex-col items-start text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-heading italic text-white mb-6">Generative UI streaming</h2>
              <p className="font-body font-light text-white/60 text-lg leading-relaxed mb-8">
      ...
      {/* CALL TO ACTION */}
      <section className="py-32 px-6 flex flex-col items-center justify-center border-t border-white/10">
        <h2 className="text-5xl md:text-7xl font-heading italic text-white mb-10 text-center">Unleash your agent.</h2>
        <Link 
          href="/chat" 
