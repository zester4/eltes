      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="font-body font-light text-white/50 text-base md:text-lg leading-relaxed space-y-6 md:space-y-12">
          <div className="space-y-3 md:space-y-4">
            ...
            <p>
              This Privacy Policy describes how Etles ("we," "us," or "our")
              collects, uses, and shares your personal information when you use
              our autonomous agent platform and related services (the
              "Services").
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>
                    Account Registration: Name, email address, password, and
                    profile information.
                  </li>
                  <li>
                    Communication: Information provided when you contact support
                    or interact with our sales team.
                  </li>
                  <li>
                    Feedback: Survey responses and comments provided about our
                    Services.
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                When you access the Services, we automatically collect certain
                technical information:
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>
                    Log Data: IP address, browser type, operating system, and
                    access times.
                  </li>
                  <li>
                    Usage Information: Pages viewed, features used, and
                    interaction with AI agents.
                  </li>
                  <li>
                    Device Data: Hardware model and unique device identifiers.
                  </li>
                </ul>
              </div>

              <h3 className="text-xl font-heading text-white/80">
                C. Agent-Specific Context
              </h3>
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  ...
                  <li>
                    Semantic Memory: Vectorized context of past interactions for
                    task continuity.
                  </li>
                  <li>
                    Tool integration status: Connection status of third-party
                    toolkits.
                  </li>
                </ul>
              </div>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>
                  Facilitating secure connections with external toolkits via
                  Composio.
                </li>
                <li>
                  Developing new features and improving system reliability.
                </li>
                <li>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>
                  With third-party service providers (e.g., cloud hosting, LLM
                ...
                <li>
                  As part of a business transition (e.g., merger or
                  acquisition).
                </li>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>
                  Local Processing: Sensitive toolkit credentials (tokens) are
                  managed locally and encrypted with AES-256-GCM.
                </li>
                <li>Encryption: All data in transit is protected via TLS.</li>
                <li>
                  Access Controls: We restrict access to personal data to
                  employees and contractors who need it to fulfill their duties.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>
                  Erasure: Request deletion of your account and all associated
                  semantic memory.
                </li>
                <li>
                  Portability: Request a copy of your personal data in a
                  machine-readable format.
                </li>
                <li>
                  Revocation: Withdraw consent for specific tool integrations at
                  any time.
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-6">
            ...
            <p>
              ...
              contact us at privacy@etles.ai.
            </p>
          </section>
        </div>
      </div>
